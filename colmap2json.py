	...
	with open(os.path.join(TEXT_FOLDER,"images.txt"), "r") as f:
		...
		for line in f:
			...
			if  i % 2 == 1:
				...
				frame={"file_path":name,"rotation":b,"transform_matrix": c2w}
